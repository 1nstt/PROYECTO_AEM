...
if __name__ == "__main__":
    ruta_instancia = "../Benchmarks/I11.txt"
    ...
    datos_i11 = cargar_instancia_khan(ruta_instancia)
    ...
    consumos_finales = np.dot(mejor_solucion.vector_binario, datos_i11['r_ij_k'])
    print(f"▶ consumo total por recurso k: {consumos_finales}")
    
    if np.all(consumos_finales <= datos_i11['b_k']):
    ...
    print(f"▶ total de ítems seleccionados: {total_seleccionados} de {datos_i11['n']} grupos")
